...
void setup() {
  ...
  thermocouple = new MAX6675_Thermocouple(Thermal_SCK_PIN, Thermal_CS_PIN, Thermal_SO_PIN);
...
void loop() {
  ...
  lcd.print(" ");
  lcd.print((int)Ave_celsius);  
  lcd.print(" ");
  lcd.print((int)Smooth_celsius);  
